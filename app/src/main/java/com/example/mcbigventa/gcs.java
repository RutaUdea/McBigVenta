...
public class gcs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v1=inflater.inflate(R.layout.fragment_gcs, container, false);
        inicializacion(v1);
        CargarConfiguracion();
    ...
    private void GurdarDatos(){
        ...
        editor.putString("GcsMostra",realMostra.getText().toString());
        editor.putString("GcsAuto",realAuto.getText().toString());
        editor.putString("GcsMcEn",realMcEntre.getText().toString());
        editor.putString("GcsMcCa",realMcCafe.getText().toString());
        editor.putString("GcsTotal",RealVentasDia.getText().toString());
        editor.commit();
        ...
        Snackbar.make(view,"Gc's Guardas con Exito",Snackbar.LENGTH_SHORT).show();
    }

    private void CargarDatos(){

        bdReferencia.child("POB").child("GcsDia").addValueEventListener(new ValueEventListener() {
            @Override
